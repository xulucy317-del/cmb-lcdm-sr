...
% Drafted from docs/results_compendium.md (commit cb1221a); every number is
% T2-confirmed and traces to a consolidated deliverable in experiments/.
...
\date{Draft of 2026-08-09 --- compiled from \texttt{docs/results\_compendium.md}}
...
Blind subset selection & minimal input support $S^*$? & all-63-subset MI ceilings $\hat I_S$ & screen recurrence flags \\
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figs/amplitude_scatter.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.92\textwidth]{figs/knee_readout_lcdm_tt_ee_lowl_envelopes.png}
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.98\columnwidth]{figs/decoder_amplitude.pdf}
...
\paragraph*{Reproducibility.} All searches ($\approx$2\,000 PySR runs,
$\approx$1\,800 CPU core-hours), consolidated deliverables, frozen thresholds,
