...
* R-P4 exhaustive full-protocol (M@c<=10 2.538 vs all-6 2.561): S+ = {omega_b, omega_cdm, H0, A_s, n_s}, paired T2 vs all-6 -0.0247 +/- 0.0229 nat -> not confirmed (all-6 stands) [subsets_full]
...
* deviations: **D-LS** level-set leg via joint (f1,f2) audit; **N-G2** S* not recurrent across the two screen seeds (ATTENTION (not screen-recurrent)) — R-P4 disposition (2026-08-14): resolved, all-6 stands at protocol budget (S+ -0.0247 +/- 0.0229 nat, not confirmed)
...
* R-P4 exhaustive full-protocol (M@c<=10 1.211 vs all-6 1.211): S+ = {omega_b, omega_cdm, H0, A_s, n_s}, paired T2 vs all-6 +0.0000 +/- 0.0000 nat -> not confirmed (all-6 stands) [subsets_full]
...
* S* = {omega_b, omega_cdm, H0, tau, A_s, n_s} (|S|=6, eta_S 1.000 +/- 0.000, screen-recurrent True) [subset_selection]
* R-P4 exhaustive full-protocol (M@c<=10 1.820 vs all-6 1.889): S+ = {omega_b, omega_cdm, H0, tau, A_s}, paired T2 vs all-6 -0.0677 +/- 0.0695 nat -> not confirmed (all-6 stands) [subsets_full]
...
* R-P4 exhaustive full-protocol (M@c<=10 2.270 vs all-6 2.198): S+ = {omega_b, omega_cdm, H0, n_s}, paired T2 vs all-6 +0.0895 +/- 0.0621 nat -> dilution-affected [subsets_full]
...
* S* = {omega_b, omega_cdm, H0, tau, A_s, n_s} (|S|=6, eta_S 1.000 +/- 0.000, screen-recurrent True) [subset_selection]
* R-P4 exhaustive full-protocol (M@c<=10 1.293 vs all-6 1.318): S+ = {omega_b, omega_cdm, H0, tau, A_s}, paired T2 vs all-6 -0.0181 +/- 0.0155 nat -> not confirmed (all-6 stands) [subsets_full]
